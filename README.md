...
Home Linux Full Duplex Encrypted Chat Server Using C Programming and OpenSSL
Full Duplex Encrypted Chat Server Using C Programming and OpenSSL
by kavin sharma September 19, 2018
C programming is one of the basic programming, that we need to study for making our base of Computer Science Engineering & Once we are done with learning a programming, it's a good habit to create a project that relates to real life scenario. So here in this post we are having a detailed overview of a Full Duplex Encrypted Chat Server Using C programming & OpenSSL
